...
import {act, renderHook} from '../../../spec-support-react'
import useDebouncedEffect, {DEFAULT_DURATION} from '../useDebouncedEffect'

describe('External > Utils React > Hooks > .useDebouncedEffect()', () => {
  let component
  let options
  let timeoutFn
